---
name: vertical-fund-admin-variance-commentary
description: >-
  Write flux commentary for every P&L and balance-sheet line over threshold — current vs
  prior period and vs budget, with the driver explained from underlying activity. Use for the
  month-end close package and management reporting. Use when users need to write variance
  commentary explaining actuals versus budget, forecast, prior period, and operational
  drivers in fund administration workflows.
---
