---
name: vertical-investment-banking-deal-tracker
description: >-
  Deal Tracker workflow for investment banking. Use when users need to maintain deal
  trackers, transaction pipelines, process status, buyer activity, diligence milestones, and
  next steps, including source-backed inputs, structured analysis, quality checks, and
