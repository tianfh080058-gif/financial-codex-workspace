---
name: vertical-wealth-management-investment-proposal
description: >-
  Investment Proposal workflow for wealth management. Use when users need to prepare
  investment proposals with objectives, allocation, manager or security rationale, risks, and
  implementation plan, including source-backed inputs, structured analysis, quality checks,
  and client-ready deliverables without inventing financial, market, company, accounting, or
  client data.
---
