---
name: vertical-operations-kyc-doc-parse
description: >-
  Parse an investor or client onboarding packet into structured KYC fields — identity,
  ownership, control, source of funds, and document inventory. Use as the first step of KYC
  screening; output feeds the rules engine. Use when users need to parse KYC documents,
  extract entity details, ownership, sanctions-relevant information, and onboarding evidence
  in financial operations and KYC workflows.
---
