---
name: agent-statement-auditor-nav-tieout
description: >-
  Tie an LP statement to the fund's NAV pack — recompute the LP's capital account from the
  NAV components and flag any line that doesn't agree. Use before LP statements are
  distributed. Use when users need to tie out NAV, capital activity, trial balances,
  allocations, statements, and fund accounting support in financial statement auditing
  workflows.
---
