---
name: vertical-investment-banking-buyer-list
description: >-
  Buyer List workflow for investment banking. Use when users need to build buyer lists,
  acquisition target universe screens, strategic buyer rationales, and outreach-ready
  profiles, including source-backed inputs, structured analysis, quality checks, and
