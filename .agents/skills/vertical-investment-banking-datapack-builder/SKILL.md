---
name: vertical-investment-banking-datapack-builder
description: >-
  Build professional financial services data packs from various sources including CIMs,
  offering memorandums, SEC filings, web search, or MCP servers. Extract, normalize, and
  standardize financial data into investment committee-ready Excel workbooks with consistent
  ...
  reporting across portfolio companies. Do not use for simple financial calculations or
  working with already-completed data packs. Use when users need to assemble investment
  banking datapacks, diligence support, source files, analysis tabs, and client-ready
  exhibits in investment banking workflows.
---
