---
name: vertical-private-equity-ai-readiness
description: >-
  Portfolio AI Readiness workflow for private equity. Use when users need to assess AI
  readiness, automation opportunities, operating data quality, and implementation priorities
  for companies or portfolios, including source-backed inputs, structured analysis, quality
  checks, and client-ready deliverables without inventing financial, market, company,
