---
name: agent-valuation-reviewer-ic-memo
description: >-
  Investment Committee Memo workflow for valuation review. Use when users need to draft
  investment committee memos, summarize deal thesis, risks, diligence findings, valuation,
  and recommendation, including source-backed inputs, structured analysis, quality checks,
