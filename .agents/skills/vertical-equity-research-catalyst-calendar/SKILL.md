---
name: vertical-equity-research-catalyst-calendar
description: >-
  Catalyst Calendar workflow for equity research. Use when users need to create equity
  research catalyst calendars for earnings, events, filings, regulatory milestones, and
  company-specific triggers, including source-backed inputs, structured analysis, quality
