---
name: agent-meeting-prep-agent-client-review
description: >-
  Client Review Prep workflow for wealth or client meeting preparation. Use when users need
  to prepare client review meetings, agendas, portfolio discussion points, financial planning
  updates, and follow-up actions, including source-backed inputs, structured analysis,
