---
name: vertical-financial-analysis-deck-refresh
description: >-
  ...
  numbers", "refresh the comps", "roll this forward", "swap in the new earnings", "change all
  the $485M to $512M", or any request to swap figures across an existing deck without
  rebuilding it.
---
