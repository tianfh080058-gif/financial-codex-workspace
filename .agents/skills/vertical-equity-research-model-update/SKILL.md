---
name: vertical-equity-research-model-update
description: >-
  Model Update workflow for equity research. Use when users need to update financial models
  for new filings, earnings, guidance, estimates, KPIs, and changed assumptions, including
  source-backed inputs, structured analysis, quality checks, and client-ready deliverables
  without inventing financial, market, company, accounting, or client data.
---
