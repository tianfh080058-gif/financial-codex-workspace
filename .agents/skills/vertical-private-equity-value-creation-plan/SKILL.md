---
name: vertical-private-equity-value-creation-plan
description: >-
  Value Creation Plan workflow for private equity. Use when users need to create private
  equity value creation plans with operational levers, initiatives, owners, KPIs, and
  timelines, including source-backed inputs, structured analysis, quality checks, and
