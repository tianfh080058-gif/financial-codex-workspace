---
name: vertical-fund-admin-accrual-schedule
description: >-
  Build the period-end accrual schedule — for each accrual, compute the entry, cite the
  support, and draft the JE. Use during month-end close; the JE is a draft for controller
  approval, not a posting. Use when users need to prepare or roll forward accrual schedules,
  month-end accruals, reversals, and accounting support in fund administration workflows.
---
