---
name: vertical-operations-kyc-rules
description: >-
  Apply the firm's KYC/AML rules grid to a parsed onboarding record — assign a risk rating,
  list every rule outcome with the rule cited, and flag what's missing or escalation-worthy.
  Use after kyc-doc-parse; this skill decides nothing, it scores and routes. Use when users
  need to apply KYC rules, screening criteria, escalation logic, risk ratings, and compliance
  review workflows in financial operations and KYC workflows.
---
