---
name: vertical-financial-analysis-xlsx-author
description: >-
  Produce a .xlsx file on disk (headless) instead of driving a live Excel workbook — for
  headless Codex sessions with no open Office app. Use when users need to produce Excel
  workbooks as file artifacts with formulas, formatting, source notes, model checks, and
  recalculation guidance in financial analysis and modeling workflows.
---
