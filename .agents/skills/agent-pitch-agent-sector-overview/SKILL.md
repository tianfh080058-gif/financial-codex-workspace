---
name: agent-pitch-agent-sector-overview
description: >-
  Sector Overview workflow for investment banking pitch workflows. Use when users need to
  prepare sector overviews, market maps, trends, peer groups, KPI benchmarks, and investment
  implications, including source-backed inputs, structured analysis, quality checks, and
