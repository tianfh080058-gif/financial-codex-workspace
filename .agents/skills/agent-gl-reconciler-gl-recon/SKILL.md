---
name: agent-gl-reconciler-gl-recon
description: >-
  Reconcile general ledger to subledger for a trade date or period — match at the position or
  transaction level, surface breaks, and classify each break by likely cause. Use for daily
  or month-end recon runs across asset classes. Use when users need to perform general ledger
  reconciliations, tie balances, explain differences, and prepare close-ready reconciliation
  support in general ledger reconciliation workflows.
---
