---
name: agent-month-end-closer-roll-forward
description: >-
  Build a roll-forward schedule for a balance-sheet account — beginning balance plus activity
  less reversals equals ending balance, with each component tied to GL. Use for month-end
  close packages and audit support. Use when users need to roll forward accounting schedules,
  supporting workpapers, month-end close files, and period-over-period changes in month-end
  close workflows.
---
