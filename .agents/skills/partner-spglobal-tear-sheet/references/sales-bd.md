...
Three queries is usually sufficient. For well-known companies, these return rich results. For smaller or private companies, Queries 2 and 3 may be sparse — that's fine. The qualitative sections still deliver value because Codex synthesizes whatever is available into useful framing.
...
This section is Codex's synthesis, not raw data from the tools. Label it clearly.
