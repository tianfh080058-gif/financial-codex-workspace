---
name: agent-valuation-reviewer-returns-analysis
description: >-
  Returns Analysis workflow for valuation review. Use when users need to analyze investment
  returns, MOIC, IRR, attribution, scenarios, waterfalls, and private equity performance
  drivers, including source-backed inputs, structured analysis, quality checks, and
