---
name: agent-meeting-prep-agent-client-report
description: >-
  Client Report workflow for wealth or client meeting preparation. Use when users need to
  produce client-ready wealth or advisory reports with portfolio results, allocation views,
  market commentary, and next actions, including source-backed inputs, structured analysis,
