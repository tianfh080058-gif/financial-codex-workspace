---
name: vertical-wealth-management-portfolio-rebalance
description: >-
  Portfolio Rebalance workflow for wealth management. Use when users need to analyze
  portfolio drift, constraints, tax considerations, trade lists, and rebalancing
  recommendations, including source-backed inputs, structured analysis, quality checks, and
