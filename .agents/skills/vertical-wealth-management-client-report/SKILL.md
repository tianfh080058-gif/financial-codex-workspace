---
name: vertical-wealth-management-client-report
description: >-
  Client Report workflow for wealth management. Use when users need to produce client-ready
  wealth or advisory reports with portfolio results, allocation views, market commentary, and
  next actions, including source-backed inputs, structured analysis, quality checks, and
  client-ready deliverables without inventing financial, market, company, accounting, or
  client data.
---
