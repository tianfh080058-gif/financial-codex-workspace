---
name: vertical-wealth-management-tax-loss-harvesting
description: >-
  Tax-Loss Harvesting workflow for wealth management. Use when users need to identify
  tax-loss harvesting opportunities, wash-sale risks, replacement exposures, and
  implementation trades, including source-backed inputs, structured analysis, quality checks,
