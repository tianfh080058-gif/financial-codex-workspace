---
name: vertical-equity-research-sector-overview
description: >-
  Sector Overview workflow for equity research. Use when users need to prepare sector
  overviews, market maps, trends, peer groups, KPI benchmarks, and investment implications,
