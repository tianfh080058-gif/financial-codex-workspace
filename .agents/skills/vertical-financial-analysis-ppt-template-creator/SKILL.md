---
name: vertical-financial-analysis-ppt-template-creator
description: >-
  Creates self-contained PPT template SKILLS (not presentations) from user-provided
  PowerPoint templates. Use ONLY when a user wants to create a reusable skill from their
  template. For creating actual presentations, use the pptx skill instead. Use when users
  need to create reusable PowerPoint templates, slide masters, layouts, formatting standards,
  and presentation assets in financial analysis and modeling workflows.
---
