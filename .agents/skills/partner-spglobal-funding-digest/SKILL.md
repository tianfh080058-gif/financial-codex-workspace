---
name: partner-spglobal-funding-digest
description: >-
  Generate a polished one-page PowerPoint slide summarizing key takeaways from recent funding
  rounds and notable capital markets activity across a user's watched sectors or companies.
  Use this skill when the user asks for a deal flow summary, weekly recap, funding digest,
  transaction roundup, or capital markets briefing. Triggers on: 'deal flow digest', 'weekly
  funding recap', 'deal roundup', 'transaction summary this week', 'what happened in [sector]
  this week', 'capital markets update', or any request to compile recent funding activity
  into a briefing slide. Produces a professional single-slide PPTX with key takeaways,
...
**Coverage:** ~43% of typical deal flow companies (strong for major tech brands like Stripe, AI platform company, Databricks, Snowflake, Discord, Shopify, SpaceX, Mistral AI, Hugging Face; weaker for niche fintech, biotech, or early-stage companies).
...
**Logo guidelines:**
- Save all logos to `/home/Codex/logos/[company-name].png`
...
pres.writeFile({ fileName: "/home/Codex/deal-flow-digest.pptx" });
```
