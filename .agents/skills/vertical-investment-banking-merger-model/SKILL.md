---
name: vertical-investment-banking-merger-model
description: >-
  Merger Model workflow for investment banking. Use when users need to build or review merger
  models, accretion dilution analysis, purchase price allocation, synergies, and financing
  assumptions, including source-backed inputs, structured analysis, quality checks, and
