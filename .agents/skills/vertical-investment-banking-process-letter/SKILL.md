---
name: vertical-investment-banking-process-letter
description: >-
  Process Letter workflow for investment banking. Use when users need to draft investment
  banking process letters, buyer instructions, transaction timelines, bid requirements, and
  data room guidance, including source-backed inputs, structured analysis, quality checks,
